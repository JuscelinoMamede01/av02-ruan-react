...
export default function Home() {
  const [characters, setCharacters] = useState([] as Props[]); //Configura o estado inicial como um array de Props
        ...
        {characters.map((charac) => (
          <ul>
            <li>
              <div
                key={charac.id}
                className="border border-solid max-h-80 flex flex-col text-start justify-center items-start border-blue-900 p-10 rounded shadow bg-green-300"
              >
                <img
                  src={charac.image}
                  alt="img-charac"
